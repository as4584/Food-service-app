...
RESTAURANTS = [
    ...
    dict(
        name="Star Tavern",
        town="Orange",
        cuisine="Pizza / Bar Pie",
        description="Real Orange, NJ institution since 1945 — legendary ultra-thin bar-style pizza.",
        image_emoji="🍕",
        image_url="https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?auto=format&fit=crop&w=800&q=80",
        website_url="https://startavern.net/",
        category="pizza",
        rating="4.7",
        eta_minutes=27,
        latitude=40.7690,
        ...
        price_range="$$",
        menu=[
            dict(category="Bar Pies", name="Thin-Crust Plain Pie", description="The famous cracker-thin bar pie.", price="15.00", image_emoji="🍕", image_url="https://images.unsplash.com/photo-1598023696416-0193a0bcd302?auto=format&fit=crop&w=800&q=80"),
            dict(category="Bar Pies", name="Sausage & Pepper Pie", description="Thin crust, sweet sausage, peppers.", price="19.00", image_emoji="🍕", image_url="https://images.unsplash.com/photo-1541745537411-b8046dc6d66c?auto=format&fit=crop&w=800&q=80"),
            dict(category="Sides", name="Garlic Bread", description="Buttery, toasted.", price="6.00", image_emoji="🧄", image_url="https://images.unsplash.com/photo-1769521001298-f0415c53e013?auto=format&fit=crop&w=800&q=80"),
            dict(category="Salads", name="House Salad", description="Crisp greens, house dressing.", price="8.00", image_emoji="🥗", image_url="https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=800&q=80"),
        ],
    ),
    dict(
        name="Kinchley's Tavern",
        town="Ramsey",
        cuisine="Pizza / Thin Crust",
        description="Real Ramsey favorite since 1937 — Bergen County's award-winning ultra-thin crust pizza.",
        image_emoji="🍕",
        image_url="https://images.unsplash.com/photo-1598023696416-0193a0bcd302?auto=format&fit=crop&w=800&q=80",
        website_url="https://www.kinchleyspizza.com/",
        category="pizza",
        rating="4.6",
        eta_minutes=34,
        latitude=41.0620,
        ...
        price_range="$$",
        menu=[
            dict(category="Pizza", name="Small Thin-Crust Pie", description="The signature ultra-thin crust.", price="14.50", image_emoji="🍕", image_url="https://images.unsplash.com/photo-1598023696416-0193a0bcd302?auto=format&fit=crop&w=800&q=80"),
            dict(category="Pizza", name="Large Pepperoni Pie", description="Thin crust, crispy pepperoni.", price="20.50", image_emoji="🍕", image_url="https://images.unsplash.com/photo-1541745537411-b8046dc6d66c?auto=format&fit=crop&w=800&q=80"),
            dict(category="Appetizers", name="Mozzarella Sticks", description="Golden fried, marinara.", price="8.50", image_emoji="🧀", image_url="https://images.unsplash.com/photo-1778449665117-2c607bbc7415?auto=format&fit=crop&w=800&q=80"),
            dict(category="Sides", name="Onion Rings", description="Hand-battered, crispy.", price="7.00", image_emoji="🧅", image_url="https://images.unsplash.com/photo-1639024471283-03518883512d?auto=format&fit=crop&w=800&q=80"),
        ],
    ),
    dict(
        name="The Sombrero Tacoria",
        town="Clifton",
        cuisine="Mexican / Tacos",
        description="Real Clifton taqueria — street tacos, burritos, and quesadillas made fresh.",
        image_emoji="🌮",
        image_url="https://images.unsplash.com/photo-1711989874705-bb85dc205541?auto=format&fit=crop&w=800&q=80",
        website_url="https://thesombrero.com/",
        category="tacos",
        rating="4.6",
        eta_minutes=21,
        latitude=40.8630,
        ...
        price_range="$$",
        menu=[
            dict(category="Tacos", name="Street Tacos (3pc)", description="Choice of protein, onion, cilantro.", price="11.99", image_emoji="🌮", image_url="https://images.unsplash.com/photo-1711989874705-bb85dc205541?auto=format&fit=crop&w=800&q=80"),
            dict(category="Tacos", name="Al Pastor Tacos (3pc)", description="Marinated pork, pineapple.", price="12.99", image_emoji="🌮", image_url="https://images.unsplash.com/photo-1687881063470-a78e6ea2590e?auto=format&fit=crop&w=800&q=80"),
            dict(category="Burritos", name="Super Burrito", description="Rice, beans, protein, guac, crema.", price="13.49", image_emoji="🌯", image_url="https://images.unsplash.com/photo-1731090389603-d63060ee08a6?auto=format&fit=crop&w=800&q=80"),
            dict(category="Sides", name="Chips & Guac", description="Fresh guacamole, warm chips.", price="6.99", image_emoji="🥑", image_url="https://images.unsplash.com/photo-1635572228172-ff4ea7f07e8f?auto=format&fit=crop&w=800&q=80"),
        ],
    ),
    dict(
        name="King Taqueria",
        ...
        description="Real Paterson taqueria — authentic tacos, tortas, and quesadillas.",
        image_emoji="🌮",
        image_url="https://images.unsplash.com/photo-1687881063470-a78e6ea2590e?auto=format&fit=crop&w=800&q=80",
        website_url="https://kingtaquerianj.com/",
        category="tacos",
        rating="4.5",
        eta_minutes=23,
        latitude=40.9130,
        ...
        price_range="$",
        menu=[
            dict(category="Tacos", name="Carne Asada Tacos (3pc)", description="Grilled steak, onion, cilantro.", price="12.49", image_emoji="🌮", image_url="https://images.unsplash.com/photo-1687881063470-a78e6ea2590e?auto=format&fit=crop&w=800&q=80"),
            dict(category="Tacos", name="Carnitas Tacos (3pc)", description="Slow-braised pork.", price="12.49", image_emoji="🌮", image_url="https://images.unsplash.com/photo-1711989874705-bb85dc205541?auto=format&fit=crop&w=800&q=80"),
            dict(category="Tortas", name="Torta Milanesa", description="Breaded steak torta, avocado.", price="11.99", image_emoji="🥪", image_url="https://images.unsplash.com/photo-1777891257610-db6e1a9be7df?auto=format&fit=crop&w=800&q=80"),
            dict(category="Drinks", name="Jarritos", description="Mexican soda, assorted flavors.", price="2.99", image_emoji="🥤", image_url="https://images.unsplash.com/photo-1633983052467-e4fb46c36e4a?auto=format&fit=crop&w=800&q=80"),
        ],
    ),
    dict(
        name="The Rock Bar & Grill",
        town="Clifton",
        cuisine="Wings / Sports Bar",
        description="Real Clifton sports bar on Main Ave — wings with 30+ sauces, burgers, and game-day eats.",
        image_emoji="🍗",
        image_url="https://images.unsplash.com/photo-1608039755401-742074f0548d?auto=format&fit=crop&w=800&q=80",
        website_url="https://www.therock414.com/",
        category="wings",
        rating="4.4",
        eta_minutes=25,
        latitude=40.8800,
        ...
        price_range="$$",
        menu=[
            dict(category="Wings", name="Buffalo Wings (10)", description="Classic buffalo, blue cheese.", price="13.50", image_emoji="🍗", image_url="https://images.unsplash.com/photo-1608039755401-742074f0548d?auto=format&fit=crop&w=800&q=80"),
            dict(category="Wings", name="Thai Chili Rock Wings (10)", description="Sweet-spicy house sauce.", price="13.50", image_emoji="🍗", image_url="https://images.unsplash.com/photo-1527477396000-e27163b481c2?auto=format&fit=crop&w=800&q=80"),
            dict(category="Handhelds", name="Rock Burger", description="Half-pound smash burger, fries.", price="14.95", image_emoji="🍔", image_url="https://images.unsplash.com/photo-1599082295807-6e4a92c0790d?auto=format&fit=crop&w=800&q=80"),
            dict(category="Starters", name="Loaded Nachos", description="Cheese, jalapeños, pico.", price="10.95", image_emoji="🧀", image_url="https://images.unsplash.com/photo-1635572228172-ff4ea7f07e8f?auto=format&fit=crop&w=800&q=80"),
        ],
    ),
    dict(
        name="Columbia BBQ",
        town="Belleville",
        cuisine="BBQ / Colombian",
        description="Real Belleville barbecue — Colombian-style grilled meats, ribs, and hearty platters.",
        image_emoji="🍖",
        image_url="https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80",
        website_url="https://columbiabbq.restaurant/",
        category="bbq",
        rating="4.5",
        eta_minutes=28,
        latitude=40.7970,
        ...
        price_range="$$",
        menu=[
            dict(category="Grill", name="Picada Platter (for 2)", description="Grilled meats, chorizo, potato, plantain.", price="29.99", image_emoji="🍖", image_url="https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80"),
            dict(category="Grill", name="BBQ Pork Ribs", description="Slow-grilled, house glaze.", price="19.99", image_emoji="🍖", image_url="https://images.unsplash.com/photo-1529193591184-b1d58069ecdd?auto=format&fit=crop&w=800&q=80"),
            dict(category="Grill", name="Grilled Chicken Platter", description="Marinated, with rice and beans.", price="15.99", image_emoji="🍗", image_url="https://images.unsplash.com/photo-1527477396000-e27163b481c2?auto=format&fit=crop&w=800&q=80"),
            dict(category="Sides", name="Sweet Plantains", description="Caramelized maduros.", price="5.49", image_emoji="🍌", image_url="https://images.unsplash.com/photo-1543339308-43e59d6b73a6?auto=format&fit=crop&w=800&q=80"),
        ],
    ),
    dict(
        name="Ani Ramen",
        ...
        description="Real Montclair ramen shop — rich tonkotsu bowls, bao buns, and Japanese small plates.",
        image_emoji="🍜",
        image_url="https://images.unsplash.com/photo-1579871494447-9811cf80d66c?auto=format&fit=crop&w=800&q=80",
        website_url="https://www.aniramen.com/",
        category="sushi",
        rating="4.6",
        eta_minutes=26,
        latitude=40.8150,
        ...
        price_range="$$",
        menu=[
            dict(category="Ramen", name="Tonkotsu Ramen", description="Pork broth, chashu, egg, scallion.", price="17.00", image_emoji="🍜", image_url="https://images.unsplash.com/photo-1617196034796-73dfa7b1fd56?auto=format&fit=crop&w=800&q=80"),
            dict(category="Ramen", name="Spicy Miso Ramen", description="Miso broth with a kick.", price="17.50", image_emoji="🍜", image_url="https://images.unsplash.com/photo-1579871494447-9811cf80d66c?auto=format&fit=crop&w=800&q=80"),
            dict(category="Buns", name="Pork Belly Bao (2)", description="Steamed buns, pickles, hoisin.", price="9.00", image_emoji="🥟", image_url="https://images.unsplash.com/photo-1611143669185-af224c5e3252?auto=format&fit=crop&w=800&q=80"),
            dict(category="Sides", name="Edamame", description="Steamed, sea salt.", price="5.50", image_emoji="🫛", image_url="https://images.unsplash.com/photo-1564834744159-ff0ea41ba4b9?auto=format&fit=crop&w=800&q=80"),
        ],
    ),
    dict(
        name="Ninja Sushi",
        town="Nutley",
        cuisine="Sushi / Japanese",
        description="Real Nutley sushi bar — fresh rolls, sashimi, and hibachi, minutes from Clifton.",
        image_emoji="🍣",
        image_url="https://images.unsplash.com/photo-1617196034796-73dfa7b1fd56?auto=format&fit=crop&w=800&q=80",
        website_url="https://ninjasushigo.com/",
        category="sushi",
        rating="4.5",
        eta_minutes=24,
        latitude=40.8210,
        ...
        price_range="$$",
        menu=[
            dict(category="Rolls", name="Spicy Tuna Roll", description="Tuna, spicy mayo, scallion.", price="8.00", image_emoji="🍣", image_url="https://images.unsplash.com/photo-1579871494447-9811cf80d66c?auto=format&fit=crop&w=800&q=80"),
            dict(category="Rolls", name="Rainbow Roll", description="California roll topped with assorted fish.", price="15.50", image_emoji="🍣", image_url="https://images.unsplash.com/photo-1617196034796-73dfa7b1fd56?auto=format&fit=crop&w=800&q=80"),
            dict(category="Sashimi", name="Tuna Sashimi (5pc)", description="Fresh sliced tuna.", price="13.50", image_emoji="🐟", image_url="https://images.unsplash.com/photo-1580822184713-fc5400e7fe10?auto=format&fit=crop&w=800&q=80"),
            dict(category="Kitchen", name="Chicken Hibachi", description="Grilled chicken, fried rice, veggies.", price="16.50", image_emoji="🍗", image_url="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=800&q=80"),
        ],
    ),
    dict(
        name="Rutt's Hut",
        ...
        description="Real Clifton landmark since 1928 — home of the deep-fried \"Ripper\" hot dog and famous relish.",
        image_emoji="🌭",
        image_url="https://images.unsplash.com/photo-1619740455993-9e612b1af08a?auto=format&fit=crop&w=800&q=80",
        website_url="https://www.ruttshut.com/",
        category="deli",
        rating="4.6",
        eta_minutes=18,
        latitude=40.8310,
        ...
        price_range="$",
        menu=[
            dict(category="Rippers", name="The Ripper", description="The famous deep-fried hot dog, house relish.", price="4.75", image_emoji="🌭", image_url="https://images.unsplash.com/photo-1619740455993-9e612b1af08a?auto=format&fit=crop&w=800&q=80"),
            dict(category="Rippers", name="Double Ripper", description="Two rippers, all the way.", price="8.50", image_emoji="🌭", image_url="https://images.unsplash.com/photo-1619740455993-9e612b1af08a?auto=format&fit=crop&w=800&q=80"),
            dict(category="Sides", name="French Fries", description="Crispy, hand-cut.", price="4.50", image_emoji="🍟", image_url="https://images.unsplash.com/photo-1780030827889-b9a2fa9a7748?auto=format&fit=crop&w=800&q=80"),
            dict(category="Sides", name="Onion Rings", description="Golden, crispy.", price="5.00", image_emoji="🧅", image_url="https://images.unsplash.com/photo-1639024471283-03518883512d?auto=format&fit=crop&w=800&q=80"),
        ],
    ),
    dict(
        name="The Hot Grill",
        town="Clifton",
        cuisine="Deli / Texas Weiners",
        description="Real Clifton classic since 1961 — Texas weiners \"all the way\" and chili cheese fries.",
        image_emoji="🌭",
        image_url="https://images.unsplash.com/photo-1619740455993-9e612b1af08a?auto=format&fit=crop&w=800&q=80",
        website_url="https://thehotgrill.com/",
        category="deli",
        rating="4.6",
        eta_minutes=19,
        latitude=40.8720,
        ...
        price_range="$",
        menu=[
            dict(category="Texas Weiners", name="Two All The Way", description="Mustard, onions, chili sauce.", price="7.50", image_emoji="🌭", image_url="https://images.unsplash.com/photo-1619740455993-9e612b1af08a?auto=format&fit=crop&w=800&q=80"),
            dict(category="Texas Weiners", name="Italian Hot Dog", description="Peppers, onions, potatoes.", price="8.50", image_emoji="🌭", image_url="https://images.unsplash.com/photo-1619740455993-9e612b1af08a?auto=format&fit=crop&w=800&q=80"),
            dict(category="Sides", name="Chili Cheese Fries", description="Fries, chili, melted cheese.", price="7.00", image_emoji="🍟", image_url="https://images.unsplash.com/photo-1780030827889-b9a2fa9a7748?auto=format&fit=crop&w=800&q=80"),
            dict(category="Drinks", name="Fountain Soda", description="Ice-cold, refillable.", price="2.50", image_emoji="🥤", image_url="https://images.unsplash.com/photo-1633983052467-e4fb46c36e4a?auto=format&fit=crop&w=800&q=80"),
        ],
    ),
    dict(
        name="Applegate Farm",
        town="Montclair",
        cuisine="Dessert / Ice Cream",
        description="Real Montclair ice cream farm stand since 1848 — homemade scoops, cones, and sundaes.",
        image_emoji="🍦",
        image_url="https://images.unsplash.com/photo-1567206563064-6f60f40a2b57?auto=format&fit=crop&w=800&q=80",
        website_url="https://applegatefarm.com/",
        category="dessert",
        rating="4.7",
        eta_minutes=23,
        latitude=40.8360,
        ...
        price_range="$",
        menu=[
            dict(category="Ice Cream", name="Double-Scoop Cone", description="Choose from 40+ homemade flavors.", price="6.25", image_emoji="🍦", image_url="https://images.unsplash.com/photo-1567206563064-6f60f40a2b57?auto=format&fit=crop&w=800&q=80"),
            dict(category="Sundaes", name="Hot Fudge Sundae", description="Homemade ice cream, hot fudge, whipped cream.", price="8.50", image_emoji="🍨", image_url="https://images.unsplash.com/photo-1563805042-7684c019e1cb?auto=format&fit=crop&w=800&q=80"),
            dict(category="Shakes", name="Thick Milkshake", description="Hand-spun, real ice cream.", price="7.00", image_emoji="🥤", image_url="https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&w=800&q=80"),
            dict(category="Ice Cream", name="Waffle Cone Dip", description="Dipped in chocolate and sprinkles.", price="7.25", image_emoji="🍦", image_url="https://images.unsplash.com/photo-1567206563064-6f60f40a2b57?auto=format&fit=crop&w=800&q=80"),
        ],
    ),
    dict(
        name="Carlo's Bakery",
        ...
        description="Real Hoboken bakery since 1910 — the \"Cake Boss\" shop, famous for lobster tails and cannoli.",
        image_emoji="🎂",
        image_url="https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=800&q=80",
        website_url="https://carlosbakery.com/",
        category="dessert",
        rating="4.5",
        eta_minutes=32,
        latitude=40.7370,
        ...
        price_range="$$",
        menu=[
            dict(category="Pastries", name="Lobster Tail", description="Flaky shell, sweet cream filling.", price="6.50", image_emoji="🥐", image_url="https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=800&q=80"),
            dict(category="Pastries", name="Cannoli", description="Ricotta cream, chocolate chips.", price="5.50", image_emoji="🍮", image_url="https://images.unsplash.com/photo-1641349268827-05362f5e726c?auto=format&fit=crop&w=800&q=80"),
            dict(category="Cakes", name="Rainbow Cookie Slice", description="Almond sponge, jam, chocolate.", price="4.75", image_emoji="🍰", image_url="https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=800&q=80"),
            dict(category="Cakes", name="Red Velvet Cupcake", description="Cream cheese frosting.", price="4.50", image_emoji="🧁", image_url="https://images.unsplash.com/photo-1614707267537-b85aaf00c4b7?auto=format&fit=crop&w=800&q=80"),
        ],
    ),
    dict(
        name="Oceanos Oyster Bar & Grill",
        town="Fair Lawn",
        cuisine="Seafood / Oyster Bar",
        description="Real Fair Lawn seafood destination — raw bar, fresh fish, and a lively oyster bar.",
        image_emoji="🦪",
        image_url="https://images.unsplash.com/photo-1717251752308-2ef72f07484e?auto=format&fit=crop&w=800&q=80",
        website_url="https://www.oceanosrestaurant.com/",
        category="seafood",
        rating="4.6",
        eta_minutes=29,
        latitude=40.9330,
        ...
        price_range="$$$",
        menu=[
            dict(category="Raw Bar", name="Oysters on the Half Shell (6)", description="Daily selection, mignonette.", price="18.00", image_emoji="🦪", image_url="https://images.unsplash.com/photo-1717251882176-acdf0d46282c?auto=format&fit=crop&w=800&q=80"),
            dict(category="Raw Bar", name="Jumbo Shrimp Cocktail", description="Chilled, house cocktail sauce.", price="16.00", image_emoji="🍤", image_url="https://images.unsplash.com/photo-1751152841080-dedb3b716b83?auto=format&fit=crop&w=800&q=80"),
            dict(category="Mains", name="Grilled Branzino", description="Whole Mediterranean sea bass, lemon.", price="32.00", image_emoji="🐟", image_url="https://images.unsplash.com/photo-1697748836791-9ddf7e616ece?auto=format&fit=crop&w=800&q=80"),
            dict(category="Soups", name="New England Clam Chowder", description="Creamy, oyster crackers.", price="9.00", image_emoji="🍲", image_url="https://images.unsplash.com/photo-1778600731540-48de5d5ae2fb?auto=format&fit=crop&w=800&q=80"),
        ],
    ),
]
